...
cl.exe /nologo /EHsc /Zi /Fdninja-bootstrap.pdb /I. /Isrc /DWIN32 /DNDEBUG /D_CONSOLE /MD ^
  ...
  src\clean.cc ^
  src\touch.cc ^
  /link /debug /pdb:ninja-bootstrap.pdb /incremental:no /subsystem:Console /opt:ref /opt:icf shlwapi.lib ^
