...
struct Subprocess {
 ...
 private:
  ...
  Subprocess(bool flush, bool have_blank_line);
...
#endif
  bool flush_;
  /// Required when @a flush_ is true because we should write a new line only
  /// if the command output something. We cannot write it up front because it
