...
`NINJA_PARALLELISM`, the number of jobs run in parallel.

The value must be greater than 0. The default value is the based on the number
of CPUs your system has.
