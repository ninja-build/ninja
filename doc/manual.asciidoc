...
_Available since Ninja 1.12._
Horizontal Tab character (0x09) can be used for indentation. Earlier Ninja
versions allow only space (0x20) character to be used for such purpose.
